...
export async function discoverConfiguredMcpServers(opts = {}) {
  const run = opts.execFileImpl ?? execFileAsync;
  const { stdout } = await run(
    'codex',
    [...CODEX_ISOLATION_CONFIG_ARGS, 'mcp', 'list', '--json'],
    {
      timeout: 5_000,
      maxBuffer: 1024 * 1024,
